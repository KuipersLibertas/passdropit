...
import { AdminPortalMenus as menus } from '@/layouts/Main/navigation';
...
export const UserLayout = ({ children }: { children: React.ReactNode }): JSX.Element => {
  ...
  return (
    <Box sx={{ minHeight: 'calc(100vh - 137px)' }}>
      <Box bgcolor={theme.palette.mode === ThemeMode.light ? '#3e0445' : '#251527'}>
        <Container>
          <Typography
            variant="h4"
            fontWeight={700}
                      ...
                      borderLeftColor: {
                        md:
                          activeLink === menu.href
                            ? theme.palette.mode === ThemeMode.light ? '#3e0445' : '#251527'
                            : 'transparent',
                      },
                      cursor: 'pointer',
                    }}
