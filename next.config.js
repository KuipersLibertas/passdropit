...
const securityHeaders = [
  ...
  { key: 'X-DNS-Prefetch-Control', value: 'on' },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://pagead2.googlesyndication.com https://partner.googleadservices.com https://tpc.googlesyndication.com https://www.dropbox.com https://live.demand.supply https://*.demand.supply https://stpd.cloud https://copyrightcontent.org https://connect.facebook.net https://apis.google.com https://accounts.google.com",
